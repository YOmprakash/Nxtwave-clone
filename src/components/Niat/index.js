...
export default function Niat() {
  return (
    ...
    <div className='niat-container'>
        ...
        <img src='https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/Home/niat-logo-desktop.svg' alt='niat-logo'className='desktop-img' />
        <img src='https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/Home/niat-logo-mobile.svg' alt='star' className='mobile-img' />
